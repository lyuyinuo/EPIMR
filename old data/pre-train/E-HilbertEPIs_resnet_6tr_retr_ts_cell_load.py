...
cell = "HeLa-S3"  # ['GM12878', 'HeLa-S3', 'HUVEC', 'IMR90', 'K562', 'NHEK']
...
data_path = '/home/puyuqian/lyu/old_data/hilbert_aug/'
...
for cell_s in cell_tr:
    en_train = np.load(data_path + cell_s + '_enhancers_tr_va.npy')
    pr_train = np.load(data_path + cell_s + '_promoters_tr_va.npy')
    l_train = np.load(data_path + cell_s + '_labels_tr_va.npy')
...
X_en_train = np.load(data_path + cell_ts + '_enhancers_tr_va.npy')
X_pr_train = np.load(data_path + cell_ts + '_promoters_tr_va.npy')
y_train = np.load(data_path + cell_ts + '_labels_tr_va.npy')
...
'''
model = load_model('./model/6cell_retr_' + cell + '_bestfrozenmodel_fold0.h5')
print('Testing model...')
model.load_weights('./model/6cell_retr_%s_bestfrozenmodel_fold0.h5' % (cell))
...
print(cell, ' train, ' + cell_ts + ' test 6 cell retrain result:')
