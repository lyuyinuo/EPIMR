...
def load_and_shuffle_data():
    data_path = '/home/puyuqian/lyu/old_data/hilbert_all_aug/'

    dataset_enhancer = np.load(data_path + cell + '_enhancers_aug.npy')
    dataset_promoter = np.load(data_path + cell + '_promoters_aug.npy')
    labels = np.load(data_path + cell + '_labels_aug.npy')
