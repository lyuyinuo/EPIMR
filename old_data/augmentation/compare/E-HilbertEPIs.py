...
cell = "NHEK"  # ['NHEK', 'IMR90', 'HUVEC', 'K562', 'GM12878', 'HeLa-S3']
training_frac = 0.9
batch_size = 128
...
data_path = '/home/puyuqian/lyu/final/old_data/aug/aug1-1/hilbert/'
...
X_en_train = np.load(data_path + cell + '_enhancers_aug_tr.npy')
X_pr_train = np.load(data_path + cell + '_promoters_aug_tr.npy')
y_train = np.load(data_path + cell + '_labels_aug_tr.npy')

X_en_valid = np.load(data_path + cell + '_enhancers_aug_va.npy')
X_pr_valid = np.load(data_path + cell + '_promoters_aug_va.npy')
y_valid = np.load(data_path + cell + '_labels_aug_va.npy')

X_en_test = np.load(data_path + cell + '_enhancers_aug_ts.npy')
X_pr_test = np.load(data_path + cell + '_promoters_aug_ts.npy')
y_test = np.load(data_path + cell + '_labels_aug_ts.npy')
