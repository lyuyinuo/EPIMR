...
data_path = '/home/puyuqian/lyu/final/old_data/aug/aug1-1/onehot/'
#out_path = data_path
for cell_line in cell_lines:
    ...
    X_en_train = np.load(data_path + cell_line + '_enhancers_aug_tr.npy')
    X_pr_train = np.load(data_path + cell_line + '_promoters_aug_tr.npy')
    y_train = np.load(data_path + cell_line + '_labels_aug_tr.npy')

    X_en_valid = np.load(data_path + cell_line + '_enhancers_aug_va.npy')
    X_pr_valid = np.load(data_path + cell_line + '_promoters_aug_va.npy')
    y_valid = np.load(data_path + cell_line + '_labels_aug_va.npy')

    X_en_test = np.load(data_path + cell_line + '_enhancers_aug_ts.npy')
    X_pr_test = np.load(data_path + cell_line + '_promoters_aug_ts.npy')
    y_test = np.load(data_path + cell_line + '_labels_aug_ts.npy')
