...
def ResNet(input_shape, net_name):  # ='resnet18'
    ...
    XY = Concatenate()([pool2_X, pool2_Y])
    XY = BatchNormalization()(XY)
    XY = Dropout(0.75)(XY)

    Dense1 = Dense(1024, activation='sigmoid', name='dense1',
                   kernel_initializer=glorot_uniform(seed=None))(XY)
    Dense2 = Dense(256, activation='sigmoid', name='dense2',
                   kernel_initializer=glorot_uniform(seed=None))(Dense1)
    Dense3 = Dense(64, activation='sigmoid', name='dense3',
                   kernel_initializer=glorot_uniform(seed=None))(Dense2)

    XY = Dense(1, activation='sigmoid', name='dense',
               kernel_initializer=glorot_uniform(seed=None))(Dense3)
