...
from resnet_block_without_multiscale import ResNet
...
cell = "GM12878"  # ['GM12878', 'HeLa-S3', 'HUVEC', 'IMR90', 'K562', 'NHEK']
batch_size = 64
opt = optimizers.Adam(lr=1e-5)
num_epochs = 50
t = datetime.now().strftime('%Y-%m-%d-%H:%M:%S')

data_path = '/home/puyuqian/lyu/final/old_data/aug/sub/hilbert/'
...
X_en_train = np.load(data_path + cell + '_enhancers_sub_tr.npy')
X_pr_train = np.load(data_path + cell + '_promoters_sub_tr.npy')
y_train = np.load(data_path + cell + '_labels_sub_tr.npy')

X_en_valid = np.load(data_path + cell + '_enhancers_sub_va.npy')
X_pr_valid = np.load(data_path + cell + '_promoters_sub_va.npy')
y_valid = np.load(data_path + cell + '_labels_sub_va.npy')

X_en_test = np.load(data_path + cell + '_enhancers_sub_ts.npy')
X_pr_test = np.load(data_path + cell + '_promoters_sub_ts.npy')
y_test = np.load(data_path + cell + '_labels_sub_ts.npy')
