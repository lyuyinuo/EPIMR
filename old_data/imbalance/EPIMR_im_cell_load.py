...
test = False
if not test:
    checkpointer = ModelCheckpoint(filepath="./model2/%s_bestmodel_fold0.h5"
...
'''
model = load_model('./model2/' + cell + '_bestmodel_fold0_810.h5')
print('Testing model...')
model.load_weights('./model2/%s_bestmodel_fold0_810.h5' % (cell))
