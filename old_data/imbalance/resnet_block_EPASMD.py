...
def ResNet(input_shape, net_name):  # ='resnet18'
    ...
    attention_add = add([pool2_X, pool2_Y], name='attention_add')
    attention_sub = subtract([pool2_X, pool2_Y], name='attention_subtract')
    attention_mul = multiply([pool2_X, pool2_Y], name='attention_mul')
    attention_dot = dot([pool2_X, pool2_Y], name='attention_dot', axes=1)

    XY = Concatenate()([pool2_X, pool2_Y, attention_add, attention_sub, attention_mul, attention_dot])
