...
import sys
import os.path
sys.path.append('/home/puyuqian/lyu/myfunc')
...
def ResNet(input_shape, net_name):  # ='resnet18'
    ...
    pool2_X = GlobalAvgPool2D(name='globalavgpool_X3')(conv_X3)
    ...
    pool2_Y = GlobalAvgPool2D(name='globalavgpool_Y3')(conv_Y3)
    ...
    XY = Concatenate()([pool2_X, pool2_Y, attention_add, attention_mul])
