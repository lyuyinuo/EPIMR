...
for cell_s in cell_tr:
    ...
    if a ==0:
        X_enhancers_tr = en_valid
        X_promoters_tr = pr_valid
        labels_tr = l_valid
        a = a + 1
    else:
...
'''
model = load_model('./model/6cell_retr_' + cell + '_bestfrozenmodel_fold0_823.h5')
print('Testing model...')
model.load_weights('./model/6cell_retr_%s_bestfrozenmodel_fold0_823.h5' % (cell))
