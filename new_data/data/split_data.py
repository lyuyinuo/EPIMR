import numpy as np
data_path = 'D:/python/new_data/'
out_path = 'D:/python/new_data/split_data/'
...
for cell_line in cell_lines:
    ...
    X = np.load(data_path + cell_line + '_enhancers.npy')
    Y = np.load(data_path + cell_line + '_promoters.npy')
    # print(X.shape)
    L = np.load(data_path + cell_line + '_labels.npy')
    print(L.shape)
    ...
    np.save(out_path + cell_line + '_enhancers_tr.npy', X_e_tr)
    np.save(out_path + cell_line + '_promoters_tr.npy', X_p_tr)
    np.save(out_path + cell_line + '_labels_tr.npy', X_l_tr)

    np.save(out_path + cell_line + '_enhancers_va.npy', X_e_va)
    np.save(out_path + cell_line + '_promoters_va.npy', X_p_va)
    np.save(out_path + cell_line + '_labels_va.npy', X_l_va)

    np.save(out_path + cell_line + '_enhancers_ts.npy', X_e_ts)
    np.save(out_path + cell_line + '_promoters_ts.npy', X_p_ts)
    np.save(out_path + cell_line + '_labels_ts.npy', X_l_ts)
