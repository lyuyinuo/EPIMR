...
model_path = '/home/puyuqian/lyu/new_data/hilbert_all_aug/model/'
model = load_model(model_path + '%s_bestmodel_fold0_34.h5' % (cell_line))

subdata_path = '/home/puyuqian/lyu/new_data/hilbert/sub/'
sub_e = np.load(subdata_path + cell_line + '_enhancers_sub.npy')
sub_p = np.load(subdata_path + cell_line + '_promoters_sub.npy')
sub_l = np.load(subdata_path + cell_line + '_labels_sub.npy')
