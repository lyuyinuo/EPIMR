...
data_path = '/home/puyuqian/lyu/new_data/hilbert_all_aug/'
...
X_enhancers = np.load(data_path + cell + '_enhancers_aug.npy')
X_promoters = np.load(data_path + cell + '_promoters_aug.npy')
...
for fold in range(1):  # 10
    ...
    model = ResNet(input_shape=(64, 96, 4), net_name='resnet34')
